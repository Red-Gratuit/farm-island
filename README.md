...
git init
git add .
git commit -m "Initial commit - Farm Island Telegram App"
```
...
### Fonctionnalités
- 🏠 Menu principal avec catalogue de produits
- 📞 Formulaire de contact
- 🔐 Panel d'administration (protégé par code "Farm59")
